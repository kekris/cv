...
\begin{parcolumns}[]{2}
  ...
  \colchunk[2]{%
    ...
    \begin{itemize}
%    \item[] 0451559391
%    \item[] \href{mailto:junhao.ke@sydney.edu.au}{junhao.ke@sydney.edu.au}
%    \item[] \href{https://wenjie-stat.me}{https://wenjie-stat.me}
    \end{itemize}
  \end{adjustwidth}
  }
...
% \begin{body}
%   \vspace{14pt}
%   \textbf{Data Processing and Analysis Assistant}
% \end{body}
%
% \smallskip
...
\begin{body}
  ...
  % Thesis: Review and Comparison on Variable Selection Methods\\
  % Advisor: Dr.\ Yanlin Tang
  %	\vspace{-4pt}
  %	\begin{itemize} \itemsep -0pt  % reduce space between items
  % \item Rank in last two year: Top 3/36
  %	\end{itemize}
\end{body}
\smallskip
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Research Experience
% \header{Other Research Experience}
% \begin{body}
%   \vspace{14pt}
%   \textbf{B.S. Thesis} \hfill \emph{January, 2014 -- June, 2014}\\
%   \vspace{-2pt}
%   \begin{itemize}
%     \setlength{\itemindent}{0in}
%     \setlength{\itemsep}{0in}
%   \item Worked on selective \textbf{review}, \textbf{simulation} and
%     \textbf{comparison} of several popular \textbf{Variable Selection}
%     approaches ranging from the classical Hypothesis Testing, Best Subset
%     and some modern regularization based techniques, such as Nonnegative
%     Garrote, Lasso, Elastic Net, Adaptive Lasso and SCAD, etc.
%   \item Advisor: Dr.\ Yanlin Tang
%   \end{itemize}

%   \textbf{Mathematical Contest in Modeling (MCM)} \hfill \emph{February 2013}\\
%   \vspace{-2pt}
%   \begin{itemize}
%     \setlength{\itemindent}{0in}
%     \setlength{\itemsep}{0in}
%   \item Participated in the Mathematical Contest in Modeling (MCM)
%     organized by the Consortium for Mathematics and Its Applications
%     (COMAP)
%   \item Worked on optimization of dilemma of ``The Ultimate Brownie Pan''
%     with teammates
%   \item Advisor: Dr.\ Zhijian Qian
%   \end{itemize}

%   \textbf{National Undergraduate Innovation Program}  \hfill
%   \emph{December 2010--2012}\\
%   \vspace{-2pt}
%   \begin{itemize}
%     \setlength{\itemindent}{0in}
%     \setlength{\itemsep}{0in}
%   \item Participated in the 2010's National Undergraduate Innovation
%     Program organized by the Ministry of Education of P.R. China
%   \item Worked on Tensor Transpose and its Properties with teammates
%   \item Advisor: Dr.\ Junfeng Yin
%   \end{itemize}
%   %	\emph {Undergraduate Student}  \hfill  December, 2010 - December, 2012\\
%   %	\vspace{-4pt}
%   %	\begin{itemize} \itemsep -0pt
%   % \item Participated in the 2010\rq{}s National Undergraduate Innovation Program
%   % \item Worked on Tensor Transpose and its Properties with teammates and Advisor Prof. Junfeng Yin of Tongji University
%   %	\end{itemize}
% \end{body}
% \smallskip
...
% \begin{body}
%   \vspace{14pt}
%   American Statistical Association, New England Statistical Society
% \end{body}
% \smallskip
...
\begin{body}
	...
	% \smallskip
	% Shanghai Rong-Guang \textbf{Scholarship} \hfill \emph{2013}\\
	% \smallskip
	% Academic \textbf{Scholarship} of Tongji University \hfill \emph{2012--2013}\\
	% \smallskip
	% Social Activity \textbf{Scholarship} of Tongji University \hfill \emph{2012--2013}\\
	% \smallskip
	% Meritorious Winner in \textbf{Mathematical Contest in Modeling} (MCM) \hfill
	% \emph{2013}\\
	% \smallskip
	% \textbf{National Undergraduate Innovation Program} Certificate  \hfill \emph{2012}\\
	% \smallskip
	% Excellent \textbf{Student Cadre} of Tongji University \hfill \emph{2012}\\
\end{body}
\smallskip
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Teaching Positions
...
\begin{body}
	...
	%	\item Achieved highest Grashof number that has been ever reported
	\end{itemize}

	
	% \textbf{Analyst Intern}\hfill
	% \emph{June, 2017 -- January, 2018} \\
	% After, Inc \hfill Norwalk, CT
	% \vspace{-2pt}
	% \begin{itemize}
	%   \setlength{\itemindent}{0in}
	%   \setlength{\itemsep}{0in}
	% \item Statistical modeling for warranty analytics
	% \item Interactive data visualization with R Shiny
	% \end{itemize}
	
	% \textbf{Analyst Intern}\hfill
	% \emph{February, 2014 -- July, 2014} \\
	% Department of Measurement Science (MSci), A.C. Nielsen \hfill Shanghai, China
	% \vspace{-2pt}
	% \begin{itemize}
	%   \setlength{\itemindent}{0in}
	%   \setlength{\itemsep}{0in}
	% \item Worked on SAS programing, assisted sample design and universe
	%   estimation, etc.
	% \end{itemize}
\end{body}
\smallskip
...
\begin{body}
	...
	% Scientific Reports --- Nature \hfill \emph{January 2017 -- Present}\\
	% \smallskip
	% \textbf{President} of Student Union \hfill \emph{July 2012 -- June 2013}\\
	% \textbf{School of Mathematical Sciences} \hfill Tongji University
	% \vspace{-2pt}
	% \begin{itemize}
	%   \setlength{\itemindent}{0in}
	%   \setlength{\itemsep}{0in}
	%   \item Organized academic and social events for the school, etc.
	% \end{itemize}
\end{body}
\smallskip
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	\vspace{14pt}
%	
%	\textbf{Research Assistant} \hfill \emph{January 2016 -- July 2019}\\
%	UConn Health Center for Population Health \hfill
%	Farmington, CT
%	\vspace{-2pt}
%	\begin{itemize}
%		\setlength{\itemindent}{0in}
%		\setlength{\itemsep}{0in}
%		\item Data cleaning and data integration of Connecticut All-Payer
%		Claims Databases (APCD) and Electronic Health Records (EHR) from
%		Connecticut Children's Medical Center (CCMC)
%		\item A suicide prevention project by survival analysis using the
%		APCD and CCMC data
%		\item Website development and interactive data visualization for
%		HealthQualityCT scorecard project using Hugo and R Shiny at
%		\url{https://healthqualityct.org}
%		\item Usage of imaging procedures for dental treatment over time
%		\item Comorbidity measures and thirty days' readmission rate of
%		joint replacement using Hospital Inpatient Discharge Data (HIDD)
%	\end{itemize}
%	
%	\textbf{Graduate Assistant} \hfill \emph{January 2017 -- May 2017}\\
%	UConn Data Science Lab \hfill Storrs, CT
%	\vspace{-2pt}
%	\begin{itemize}
%		\setlength{\itemindent}{0in}
%		\setlength{\itemsep}{0in}
%		\item Set up project templates in R Mardown with HTML widgets and Shiny
%		Applications
%		\item Sample projects on survival analysis with deep neural
%		network model
%	\end{itemize}
%	
%\end{body}
