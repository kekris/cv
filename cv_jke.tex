...
\begin{body}
  ...
  \smallskip
  {\bf Invited talk:} On the numerical simulation of a natural convection boundary layer. In the Centre of Wind, Waves and Water, Sydney, NSW Australia, 22 June 2018.
...
\begin{body}
	\vspace{14pt}
	\textbf{Casual Lecturer and Unit of Study Coordinator} \hfill \emph{February 2022 -- Present}\\
	Faculty of Engineering and IT, USyd \hfill NSW
	\vspace{-2pt}
	\begin{itemize}
		\setlength{\itemindent}{0in}
		\setlength{\itemsep}{0in}
		\item Deliver lectures, provide teaching materials and resources to tutors and students, as well as administering the assessments.
		Course includes: Engineering Analysis (AMME2000)
	\end{itemize}
\end{body}
\smallskip
\begin{body}
