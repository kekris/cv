...
\begin{parcolumns}[]{2}
  \colchunk[1]{%
    ...
    \begin{itemize}
	\item[\orcid{0000-0002-1177-1834}] 0000-0002-1177-1834
...
\begin{body}
  ...
  \smallskip
  Doctor of Philosophy \hfill \emph{March 2017 -- (Expected) December 2020}\\
  Advisors: Dr.\ Nicholas Williamson \& Prof.\ Steven Armfield \\
  \smallskip
  \textbf{The University of Sydney} \hfill{NSW, Australia}\\
  \smallskip
  Master of Professional Engineering \hfill \emph{March 2015 -- December 2016}\\
  Advisors: Dr.\ Nicholas Williamson \& Prof.\ Steven Armfield \\
  \smallskip
...
\begin{body}
  ...
  \textbf{Ke, J.}, Williamson, N., Armfield, S. W., Norris, S. E., \& Komiya, A.  High Grashof number turbulent natural convection on an infinite vertical wall. (Submitted to \emph{Journal of Fluid Mechanics})
